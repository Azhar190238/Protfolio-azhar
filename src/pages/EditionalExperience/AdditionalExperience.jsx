...
const AdditionalExperience = () => {
  ...
  const educationData = [
    {
      title: "Youth Leadership Training on Tolerance & Inclusion",
      heading: "Certified Trainee",
      school: "Rupantar (under PEACE Consortium)",
      location: "Bangladesh",
      mascot: <FaGraduationCap className="text-[#35a9df] lg:text-5xl md:text-4xl text-3xl" />,
      year: "Nov–Dec 2023",
      achievements: ["Youth Leadership Training Certificate"],
      skills: [
        "Tolerance & Inclusion",
        "Conflict Resolution",
      ...
      description:
        "Completed a comprehensive training program focused on promoting tolerance and inclusion among youth. Organized by Rupantar under the PEACE Consortium to empower youth in preventing extremism through active community engagement.",
    },
    {
      title: "Vice-President of SSF-KU",
      heading: "Student Leader",
      school: "Satkhira Students Forum – Khulna University (SSF-KU)",
      location: "Khulna, Bangladesh",
      mascot: <FaGraduationCap className="text-[#35a9df] lg:text-5xl md:text-4xl text-3xl" />,
      year: "2022-2023",
      achievements: ["Organizational Leadership", "Community Building"],
      skills: [
        "Team Management",
        "Event Coordination",
      ...
      description:
        "Served as Vice-President of SSF-KU, representing over 300 students from Satkhira district. Played a key role in organizing events, addressing student concerns, and strengthening the network and collaboration among members.",
    }
  ];
